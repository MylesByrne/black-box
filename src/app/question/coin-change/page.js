...
export default function ProblemPage() {
  const problemId = "coin-change"; // Hardcoded
...
def check_solution():
  ...
  for i in range(len(testCases)):
      ...
      coins = testCase.get("coins", [])
      amount = testCase.get("amount", 0)
      expected = testCase.get("expected", -1)
      
      # Call the coinChange function with the coins array and target amount
