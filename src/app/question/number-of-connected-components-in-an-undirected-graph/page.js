...
export default function ProblemPage() {
  const problemId = "number-of-connected-components-in-an-undirected-graph"; // Hardcoded
...
def check_solution():
  ...
  for i in range(len(testCases)):
      ...
      n = testCase.get("n", 0)
      edges = testCase.get("edges", [])
      expected = testCase.get("expected", 0)
      
      # Call the countComponents function with the number of nodes and edges
