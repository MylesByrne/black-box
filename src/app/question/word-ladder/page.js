...
export default function ProblemPage() {
  const problemId = "word-ladder"; // Hardcoded
...
def check_solution():
  ...
  for i in range(len(testCases)):
      ...
      beginWord = testCase.get("beginWord", "")
      endWord = testCase.get("endWord", "")
      wordList = testCase.get("wordList", [])
      expected = testCase.get("expected", 0)
      
      # Call the ladderLength function with the begin word, end word, and word list
