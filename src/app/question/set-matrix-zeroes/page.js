...
export default function ProblemPage() {
  const problemId = "set-matrix-zeroes"; // Hardcoded
...
def check_solution():
  ...
  for i in range(len(testCases)):
      ...
      # Create a deep copy of the matrix for the solution to modify in-place
      matrix = [row[:] for row in testCase.get("matrix", [])]
      
      # Call the setZeroes function which modifies the matrix in-place
      ...
      if matrix == expected:
          ...
          print(f"Input matrix: {testCase.get('matrix', [])}")
